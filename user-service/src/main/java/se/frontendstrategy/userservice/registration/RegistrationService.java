...
import se.frontendstrategy.userservice.users.RabbitMQ;
...
//    private final EmailSender emailSender;
    ...
    public String registerUser(RegistrationRequest request) {
        ...
        boolean validFname= request.getFirstName() == null;
        boolean validLname= request.getLastName() == null;
        boolean validEmail= request.getEmail() == null;
        boolean validPassword= request.getPassword() == null;
        boolean validAddress= request.getAddress() == null;
        boolean validPhone= request.getPhone() == null;
        if(!isValidEmail){
            throw new IllegalStateException("email not valid");
        }
        else if (validFname || validLname || validEmail || validPassword || validAddress
                || validPhone){
        ...
        try {
            RabbitMQ.sender(request.getFirstName(), request.getEmail());
        } catch (IOException e) {
            e.printStackTrace();
...
//        emailSender.send(request.getEmail(),buildEmail(request.getFirstName(),link));
    ...
    public String confirmToken(String token) {
        ...
        service.enableUser(
                confirmationToken.getUsr().getEmail());
        return "confirmed";
    }
    ...
    public User updateUser(RegistrationRequest request, String email) {
        return service.updateUser(request, email);
    }
