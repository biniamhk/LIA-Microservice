...
namespace WpfUi.ViewModels
{
    public class NavigationBarViewModel : ViewModelBase
    {
        ...
        public NavigationBarViewModel(INavigator navigator, IViewModelFactory viewModelFactory,
            IAuthenticator authenticator, IApiHelper apiHelper)
        {
            _navigator = navigator;
            _viewModelFactory = viewModelFactory;
            _authenticator = authenticator;
            UpdateCurrentViewModelCommand = new UpdateCurrentViewModelCommand(_navigator, _viewModelFactory);
            LogoutCommand = new LogoutCommand(_authenticator, _navigator, _viewModelFactory);
